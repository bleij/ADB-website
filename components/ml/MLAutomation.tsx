...
export default function MLAutomation() {
    ...
    return (
        <section className="bg-white py-8 px-2 md:py-20 md:px-6" style={{fontFamily: "'Manrope', sans-serif"}}>
            <div
                className="max-w-7xl mx-auto bg-[#f4f4f4] rounded-[40px] p-6 md:p-14 flex flex-col md:flex-row gap-8 md:gap-12">
                {/* Левая панель */}
                ...
                {/* Правая карточка */}
                <div
                    className="flex-[1.2] bg-white rounded-3xl border border-gray-200 p-6 md:p-8 flex flex-col justify-between min-h-[300px]">
                    <div>
                    ...
                    <button
                        className="mt-6 self-start px-5 py-2 rounded-md bg-[#D7001D] text-white font-semibold hover:bg-[#c10019] transition">
                        Узнать больше →
                    </button>
                </div>
            </div>
