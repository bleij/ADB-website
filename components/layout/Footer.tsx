...
const Footer: React.FC = () => {
    return (
        <div className="bg-white w-full pt-24">
            <footer
                className="relative overflow-hidden bg-[#D7001D] text-white py-24 px-10 rounded-t-[60px] mx-auto"
            ...
            >
                ...
                {/* Контент */}
                <div className="relative z-10 w-[92%] mx-auto flex flex-col gap-12">
                    {/* Верхний блок: лого + навигация + соцсети */}
                    <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-10">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:items-center gap-10">
                            {/* Навигация */}
                            <nav className="absolute left-1/2 transform -translate-x-1/2 flex gap-8 text-[18px] font-medium">
                            ...
                            <div className="flex gap-4">
                                <a href="#" aria-label="LinkedIn">
                                    <img src="/icons/social/linkedin.svg" alt="LinkedIn" className="w-8 h-8" />
                                </a>
                                <a href="#" aria-label="Facebook">
                                    <img src="/icons/social/facebook.svg" alt="Facebook" className="w-8 h-8" />
                                </a>
                                <a href="#" aria-label="Twitter">
                                    <img src="/icons/social/twitter.svg" alt="Twitter" className="w-8 h-8" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-[18px] leading-relaxed space-y-4">                        <div><strong>Почта:</strong> info@adb.com</div>
                        <div><strong>Телефон:</strong> +7 777 123 45 67</div>
                        <div><strong>Адрес:</strong> Казыбек 12/2</div>
                    </div>

                    {/* Линия */}
                    <div className="h-[2px] w-full bg-white opacity-50 my-6" />

                    {/* Низ */}
                    <div className="flex flex-col md:flex-row justify-between items-center text-[16px] text-white/90 gap-4">
