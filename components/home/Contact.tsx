...
const Contact: React.FC = () => {
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    <h2 className="text-4xl sm:text-5xl font-medium mb-6 text-black leading-tight">
                        Превратим вашу идею в <br className="hidden sm:block" />
                        реальность
                    </h2>
  ...
  "
                        ...
                        <button
                            type="submit"
                            className="w-full sm:w-[220px] h-[60px] sm:h-[72px] bg-[#4B4B4B] text-white text-base sm:text-lg font-semibold rounded-full"
                        >
                            Отправить
                        </button>
