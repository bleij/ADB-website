...
export default function PixelCard({
    ...
    return (
        <div
            ref={containerRef}
            className={`w-full h-full relative overflow-hidden grid place-items-center border border-[#f0f0f0] rounded-[25px] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
